...
/* End includes */
class Anv_SpinTEvolve_3d:public Oxs_TimeEvolver {
private:
  mutable OC_UINT4m mesh_id;
	Oxs_OwnedPointer<Oxs_VectorField> u_init;
	
	//spin-torque parameter
  mutable Oxs_MeshValue<ThreeVector> u;
  ThreeVector ave_u; // Average value of u, excluding u_profile term.
  ...
  OC_REAL8m Ystep; // y distance between 2 positions
  OC_REAL8m Zstep; // z distance between 2 positions
	OC_INDEX n_x; // nb of cells in x direction
  OC_INDEX n_y; // nb of cells in y direction
  OC_INDEX n_z; // nb of cells in z direction
  OC_INDEX n_xy; // nb of cells in xy plane
  ...
  Oxs_ScalarOutput<Anv_SpinTEvolve_3d> max_dm_dt_output;
  Oxs_ScalarOutput<Anv_SpinTEvolve_3d> dE_dt_output;
  Oxs_ScalarOutput<Anv_SpinTEvolve_3d> delta_E_output;
  Oxs_ScalarOutput<Anv_SpinTEvolve_3d> ave_u_output;
  Oxs_ScalarOutput<Anv_SpinTEvolve_3d> ave_ux_output;
  Oxs_ScalarOutput<Anv_SpinTEvolve_3d> ave_uy_output;
  Oxs_ScalarOutput<Anv_SpinTEvolve_3d> ave_uz_output;
  Oxs_VectorFieldOutput<Anv_SpinTEvolve_3d> dm_dt_output;
  Oxs_VectorFieldOutput<Anv_SpinTEvolve_3d> mxH_output;
  Oxs_VectorFieldOutput<Anv_SpinTEvolve_3d> spin_torque_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Anv_SpinTEvolve_3d::* rkstep_ptr));
  ...
  Anv_SpinTEvolve_3d(const Anv_SpinTEvolve_3d&);
  Anv_SpinTEvolve_3d& operator=(const Anv_SpinTEvolve_3d&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Anv_SpinTEvolve_3d(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Anv_SpinTEvolve_3d();
