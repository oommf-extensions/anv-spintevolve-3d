...
private:
  ...
  OC_REAL8m ave_ux; // Average value of u_x, excluding u_profile term.
  OC_REAL8m ave_uy; // Average value of u_y, excluding u_profile term.
  OC_REAL8m ave_uz; // Average value of u_z, excluding u_profile term.
  ...
  Oxs_ScalarOutput<Anv_SpinTEvolve> ave_ux_output;
  Oxs_ScalarOutput<Anv_SpinTEvolve> ave_uy_output;
  Oxs_ScalarOutput<Anv_SpinTEvolve> ave_uz_output;
